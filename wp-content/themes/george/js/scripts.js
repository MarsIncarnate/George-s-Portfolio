...
function funMouse() {
	...
	const elements = [...document.querySelectorAll("a,.elementor-menu-toggle, .dbtn, button, .swiper-pagination-bullet, .e-form__buttons__wrapper")];
...
jQuery(document).ready(function($) {
    ...
    $('.header .elementor-menu-toggle, .btnOverlay, .menu-button a').on("click", function() {
		$('body').toggleClass('menu-active');
    }); 
    
    $('.view_more .elementor-icon-list-item').on("click", function() {
		$('.clientWrap').toggleClass('view-active');
    }); 
    ...
    $(".srv2Boxes .elementor-column-wrap").click(function(event) {
        $(event.target).closest(".srv2Boxes .elementor-column-wrap").toggleClass("text-active");
    });
    ...
    $(window).scroll(function (event) {
		$(".cubic-animation, .boldWrap a.e-gallery-item").each(function (i, el) {
			var el = $(el);
			if (el.visible(true)) {
			  el.addClass("effect");
			} else {
        ...
        $(".srv2Wrap .bx1, .srv2Wrap .bx2, .workWrapper .item").each(function (i, el) {
			var el = $(el);
			if (el.visible(true)) {
			  el.addClass("effect");
			}
    ...
    $("nav.elementor-nav-menu--dropdown .row > ul.elementor-nav-menu").wrap("<div class='mobmenuBox'></div>");  
    $('.footer .contactBox').clone().appendTo('nav.elementor-nav-menu--dropdown .mobmenuBox'); 
    // elementor mobMenu toggle js
    $('.header .elementor-menu-toggle i').append('<span></span><span></span><span></span><span>Menu</span>');      
    $("nav.elementor-nav-menu--dropdown .row .menu-image").wrap("<div class='hoverBox'><div class='hoverOver'></div></div>");

     
 	$(".footer .getBox").appendTo(".footer");
	$('.hloWrap .hloImg .elementor-image,.hloWrap .elementor-widget-video .elementor-open-inline').append('<span class="circle1"></span><span class="circle2"></span><span class="circle3"></span><span class="circle4"></span>');
	...
	$(".hmbnrWrap .particlesBx").appendTo(".hmbnrWrap");
	
	//owl-carousel
  	var owl = $('.owl-carousel-slider-home');
	owl.owlCarousel({
	    items:1,
	    loop:true,
	    margin:0,
    ...
    var owl = $('.owl-carousel-slider-more-project');
	owl.owlCarousel({
	    loop:true,
	    autoplay:false, 
	    autoplayTimeout:8000,
	    autoplayHoverPause:true,
	    navContainer: '#MyNavs1',
        responsive: {
        0:{
            margin:0,
            items:1
    ...
    var owl = $('.owl-carousel-slider-more-project-mobile');
	owl.owlCarousel({
	    loop:true,
	    autoplay:false, 
	    autoplayTimeout:8000,
	    autoplayHoverPause:true,
	    navContainer: '#MyNavs2',
        responsive: {
        0:{
            margin:0,
            items:1
	...
	$(window).on("load scroll", function() {
		var parallaxElement = $(".moving-block"),
